<template>
    <div class="relative">
            ...
            <div class="flex justify-between items-center border-b-2 border-gray-400 border-opacity-20 py-6 md:justify-start md:space-x-10">
                ...
                <nav class="hidden md:flex space-x-10">
                    <div class="relative">
                        ...
                        >
                            <div v-show="showSolutionsFlyout" class="absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
                    ...
                    <div class="relative">
                        <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
                        <button aria-expanded="false" class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" type="button">
                            <span>More</span>
                            <!--
                                    Heroicon name: solid/chevron-down
                        ...
                        <transition
                            ...
                            leave-to-class="opacity-0 translate-y-1"
                        >
                            <div v-show="showMoreFlyout" class="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
                                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                    <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                        <a class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50" href="#">
        ...
        >
            <div :show="showMobileNavigation" class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
