        ...
        <transition
            ...
            <div v-show="open"
                ...
                <div class="rounded-md bg-white shadow-xs">
                    <div class="py-1">
                        <div v-for="(language, index) in languages" @click="selectedLanguage(index)"
                            :key="index"
                            ...
                            :class="[ language.value === currentLanguage.value ? 'bg-gray-200 hover:bg-gray-300' : 'hover:bg-gray-100' ]">
                            {{ language.flag }}
    ...
    export default {
        ...
        methods: {
            selectedLanguage(index) {
                ...
                this.open = false
                this.$emit('changed', this.currentLanguage.value)
            },
            closeDropdown() {
                this.open = false
            }
