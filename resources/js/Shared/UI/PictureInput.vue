<template>
    <div>
        ...
        <div class="flex w-full mt-2" ref="container">
            ...
            <div
                ...
                class="relative w-full overflow-hidden rounded-md cursor-pointer aspect-w-21 aspect-h-9"
            >
                <div
                    id="dragndrop-target"
                ...
                >
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        <button
                            type="button"
                            class="font-medium text-blue-600 transition duration-150 ease-in-out cursor-pointer hover:text-indigo-500 focus:outline-none focus:underline"
                            @click="select()"
                        >
                            <!-- TODO: Select Image? -->
                            Lade ein Foto hoch
...
export default {
    ...
    props: {
        id: {
            type: String,
            default() {
                return `picture-input-${this._uid}`;
            },
        },
        label: String,
        errors: {
