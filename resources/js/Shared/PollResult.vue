            ...
            <div class="mt-4 rounded">
                ...
                <div v-for="(vote, index) in this.results.votes" :key="index">
                    <div class="flex flex-row items-center justify-start">
                        <div
                            class="w-32 px-2 py-1 mt-2 font-semibold text-center rounded sm:mt-0 dark:bg-yellow-500 dark:text-gray-900"
                        >
                            Stimmen: {{ vote.votes }}
                        </div>
                        <div
                            class="mt-2 ml-2 font-medium text-center sm:text-left sm:mt-0"
                        >
                            {{ vote.name }}
                        </div>
                    </div>
...
<script>
import PollChart from "../components/Poll/PollChart.vue";
export default {
    name: "PollResult",
