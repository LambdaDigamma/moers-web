<template>
    ...
    <div>
        <div class="flex items-center border-gray-500 border-b">
            <button class="flex-shrink-0 p-2 my-3 ml-4"
                    @click="$emit('close')">
                <svg fill="currentColor" viewBox="0 0 20 20" class="w-6 h-6 text-gray-900">
                    <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
                </svg>
            </button>
            <div class="flex-1 ml-4">
                <h1 class="font-medium text-gray-900 leading-none">Details</h1>
                <p class="mt-1 text-gray-600 text-sm leading-none">Eintrag</p>
            </div>
        </div>
        ...
        <div class="p-4 border-b border-gray-200">
            <h1 class="text-2xl font-semibold text-gray-900">{{ entry.name }}</h1>
            <span class="text-base font-medium text-gray-600">{{ entry.street }} {{ entry.house_number }}</span>
        </div>

        <div class="p-4 md:py-6 border-b border-gray-200">
