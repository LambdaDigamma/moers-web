    ...
    <div class="flex items-center bg-white rounded shadow dark:bg-gray-700">
        ...
        >
            <div class="flex items-baseline">
                ...
                <svg
                    class="w-2 h-2 dark:fill-gray-600 md:ml-2"
            ...
            <div
                slot="dropdown"
                class="w-screen px-4 py-6 mt-2 bg-white rounded shadow-lg dark:bg-gray-600"
        ...
        />
        <button
            class="hidden ml-4 text-sm text-gray-600 md:flex hover:text-gray-600 focus:text-yellow-500"
            type="button"
            @click="$emit('reset')"
        >
            Zurücksetzen
