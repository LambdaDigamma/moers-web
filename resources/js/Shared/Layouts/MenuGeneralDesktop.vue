...
<script>
    ...
    export default {
        name: "MenuGeneralDesktop",
        components: {MenuItemDesktop},
        props: {
            url: String,
        },
        methods: {
