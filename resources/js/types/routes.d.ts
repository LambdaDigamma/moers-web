...
declare module 'momentum-trail' {
    export interface RouterGlobal {
        ...
        routes: {
            ...
            'api.locations.store': { uri: 'api\/v1\/locations'; methods: ['POST'] };
            'api.locations.show': { uri: 'api\/v1\/locations\/{location}'; methods: ['GET', 'HEAD']; parameters: ['location'] };
            'api.locations.update': { uri: 'api\/v1\/locations\/{location}'; methods: ['PUT', 'PATCH']; parameters: ['location'] };
            'api.locations.destroy': { uri: 'api\/v1\/locations\/{location}'; methods: ['DELETE']; parameters: ['location'] };
            ...
            'locations.show': { uri: 'locations\/{location}'; methods: ['GET', 'HEAD']; parameters: ['location'] };
            'locations.edit': { uri: 'locations\/{location}\/edit'; methods: ['GET', 'HEAD']; parameters: ['location'] };
            'locations.update': { uri: 'locations\/{location}'; methods: ['PUT', 'PATCH']; parameters: ['location'] };
            'locations.destroy': { uri: 'locations\/{location}'; methods: ['DELETE']; parameters: ['location'] };
