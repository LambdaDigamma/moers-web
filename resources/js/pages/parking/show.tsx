                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-sm text-zinc-500">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            <div
                                                className={`size-2 rounded-full ${parkingArea.state === 'open' ? 'bg-emerald-500' : 'bg-zinc-300'}`}
                                            />
                                            {parkingArea.state === 'open' ? 'Geöffnet' : 'Geschlossen'}
                                        </div>
                                        {parkingArea.updated_at && (
                                            <div>Zuletzt aktualisiert: {format(parseISO(parkingArea.updated_at), 'HH:mm', { locale: de })} Uhr</div>
                                        )}
                                    </div>
                                </div>
                            </div>
                        ...
                        <Card className="border-zinc-200 bg-white shadow-sm dark:border-white/5 dark:bg-zinc-900">
                            ...
                            <CardContent className="space-y-6">
                                <div className="flex flex-col items-center justify-center rounded-3xl bg-zinc-50 py-12 dark:bg-white/5">
                                    ...
                                    <div className="mt-2 text-sm font-bold tracking-widest text-zinc-500 uppercase">Freie Plätze</div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-4">
                                        <div className="mb-2 flex items-center justify-between text-xs font-bold tracking-wider uppercase">
