<template>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <main>
            ...
            <ul>
                <li>
                    &bull; <a href="https://firebase.google.com/policies/analytics" class="hover:underline text-red-500">Firebase Analytics</a>
                </li>
                <li>
                    &bull; <a href="https://fabric.io/privacy" class="hover:underline text-red-500">Fabric</a>
                </li>
                <li>
                    &bull; <a href="http://try.crashlytics.com/terms/privacy-policy.pdf" class="hover:underline text-red-500">Crashlytics</a>
                </li>
            </ul>
            ...
            <h2 class="my-4 font-semibold text-2xl">Sicherheit</h2>
            ...
            <h2 class="my-4 font-semibold text-2xl">Links zu externen Seiten</h2>
