<template>
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <main>
            ...
            <h2 class="my-4 text-2xl font-semibold">Sammlung und Verwendung von Daten</h2>
            ...
            <ul>
                <li>
                    &bull; <a href="https://firebase.google.com/policies/analytics" class="text-red-500 hover:underline">Firebase Analytics</a>
                </li>
                <li>
                    &bull; <a href="https://fabric.io/privacy" class="text-red-500 hover:underline">Fabric</a>
                </li>
                <li>
                    &bull; <a href="http://try.crashlytics.com/terms/privacy-policy.pdf" class="text-red-500 hover:underline">Crashlytics</a>
                </li>
            </ul>
            ...
            <p class="mt-2">
                ...
                Ich kann aus folgenden Gründen Drittfirmen und Einzelpersonen beauftragen:<br />
            ...
            <h2 class="my-4 text-2xl font-semibold">Links zu externen Seiten</h2>
            ...
            <h2 class="my-4 text-2xl font-semibold">Datenschutzhinweis für Kinder</h2>
            ...
            <h2 class="my-4 text-2xl font-semibold">Änderungen dieser Datenschutzerklärung</h2>
