...
<!--                <div class="">-->
<!--                    <svg class="hidden w-full sm:block" style="margin-top: -170px;" viewBox="0 0 1440 600" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2">-->
<!--                        <path d="M0 0h1440v514.7L1320 536c-120 21.7-360 63.7-600 64-240-.3-480-42.3-600-64L0 514.7V0z" fill="currentColor" />-->
<!--                    </svg>-->
<!--                    <svg class="block w-full sm:hidden" style="" viewBox="0 0 1440 600" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2">-->
<!--                        <path d="M0 0h1440v514.7L1320 536c-120 21.7-360 63.7-600 64-240-.3-480-42.3-600-64L0 514.7V0z" fill="currentColor" />-->
<!--                    </svg>-->
<!--                </div>-->
<!--            </div>-->
            ...
            <div class="absolute inset-x-0 top-0 overflow-x-hidden">
                <div class="relative px-4 py-3 md:px-4 md:py-4">
                    <div class="flex items-center justify-between w-full md:max-w-6xl md:mx-auto md:items-center">
                        ...
                        <div>
                            <a href="#" class="inline-block py-1 text-2xl font-bold text-gray-800 md:py-2 dark:text-white">Mein Moers</a>
                        </div>

<!--                    <div>-->
<!--                        <div class="hidden md:block">-->
<!--                            <a href="#"-->
<!--                               class="inline-block py-1 mr-6 font-bold text-gray-600 md:py-4">-->
<!--                                How it Works-->
<!--                            </a>-->
<!--                            <a href="#"-->
<!--                               class="inline-block py-1 mr-6 text-gray-500 md:py-4 hover:text-gray-600">-->
<!--                                Solutions-->
<!--                            </a>-->

<!--                            <a href="#" class="inline-block py-1 mr-6 text-gray-500 md:py-4 hover:text-gray-600">-->
<!--                                Pricing-->
<!--                            </a>-->
<!--                            <a href="#"-->
<!--                               class="inline-block py-1 mr-6 text-gray-500 md:py-4 hover:text-gray-600">-->
...
<!--                                          class="inline-block py-1 text-gray-500 md:py-4 md:mr-6 hover:text-gray-600 dark:text-gray-600">-->
<!--                                Zum Portal-->
<!--                            </inertia-link>-->
...
<!--                    <div class="">-->
<!--                        <div class="mt-4">-->
<!--                            <div class="max-w-3xl py-4 mx-auto overflow-hidden text-center rounded-lg sm:px-6 lg:py-8 lg:px-8 bg-red-50">-->
<!--                                <h2 class="text-xl font-extrabold tracking-tight text-gray-900 sm:text-3xl md:text-4xl md:leading-9 sm:leading-10">-->
...
<!--                    </div>-->
                    ...
                    <div class="px-4 pt-16 pb-10">
                        <div class="relative w-full text-center md:max-w-2xl md:mx-auto">
                            ...
                            <a href="https://apps.apple.com/de/app/mein-moers/id1305862555?mt=8" class="block mx-auto mt-2" target="_blank" style="display:inline-block;overflow:hidden;background:url(https://linkmaker.itunes.apple.com/de-de/badge-lrg.svg?releaseDate=2018-02-19&kind=iossoftware&bubble=ios_apps) no-repeat; width:135px; height:40px;" />

                            <!-- Circles -->
                            <div class="absolute bottom-0 right-0 hidden w-32 h-32 -mb-64 bg-gray-600 rounded-full md:block -mr-88"></div>
                            <div class="absolute top-0 right-0 hidden w-5 h-5 mt-32 -mr-40 bg-red-600 rounded-full md:block dark:bg-yellow-500"></div>
                        </div>
                    </div>
                    <div>
                ...
                <p class="p-4 mt-10 text-center text-gray-600">
                    Ein Projekt von
                    <a class="text-blue-500 border-b dark:text-yellow-500 dark:border-yellow-500"
                       href="https://lambdadigamma.com/"
                       target="_blank">
                        Lennart Fischer.
                    </a>
                </p>
...
<!--                            </div>-->
                            ...
                            <div class="px-5 py-2">
                                <inertia-link :href="route('legal.tac')" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    AGBs
                                </inertia-link>
                            </div>
                            <div class="px-5 py-2">
                                <inertia-link :href="route('legal.imprint')" class="text-base leading-6 text-gray-500 hover:text-gray-900">
                                    Impressum
                                </inertia-link>
                            </div>
                        </nav>
                        <div class="flex justify-center mt-8">
                            <a href="https://instagram.com/lambdadigamma" target="_blank" class="ml-6 text-gray-400 hover:text-gray-500">
                            ...
                            <a href="https://twitter.com/lambdadigamma" target="_blank" class="ml-6 text-gray-400 hover:text-gray-500">
                                <span class="sr-only">Twitter</span>
                                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"/>
                                </svg>
                            </a>
                            <a href="https://github.com/lambdadigamma" target="_blank" class="ml-6 text-gray-400 hover:text-gray-500">
