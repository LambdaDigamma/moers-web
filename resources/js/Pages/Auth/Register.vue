    ...
    >
        <div class="w-full max-w-md">
            <div>
                ...
                <p
                    class="mt-2 text-sm leading-5 text-center text-gray-600 max-w"
                >
                    oder
                    <inertia-link
                        :href="route('login')"
                        class="font-medium text-red-600 transition duration-150 ease-in-out hover:text-red-500 focus:outline-none focus:underline"
                    >
            ...
            <form class="mt-8" @submit.prevent="submit">
                ...
                <div class="mt-6">
                    ...
                    >
                        <span class="absolute left-0 pl-3 inset-y">
                            <svg
                                class="w-5 h-5 text-red-400 transition duration-150 ease-in-out group-hover:text-red-300"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                            >
                                <path
                ...
                >
                    ...
                    <p v-if="$page.props.errors.first_name">
                        {{ $page.props.errors.first_name[0] }}
                    </p>
                    <p v-if="$page.props.errors.last_name">
                        {{ $page.props.errors.last_name[0] }}
                    </p>
                    <p v-if="$page.props.errors.password">
                        {{ $page.props.errors.password[0] }}
                    </p>
                    <p v-if="$page.props.errors.password_confirmation">
                        {{ $page.props.errors.password_confirmation[0] }}
                    </p>
                </div>
                ...
                <div class="mt-6" id="appleid-signin">
                    <span class="block w-full rounded-md shadow-sm">
                        <a
                            :href="this.endpoint"
                            class="flex justify-center w-full px-4 py-2 text-base font-medium text-white transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md hover:bg-gray-800 focus:outline-none focus:border-gray-700 focus:ring-gray active:bg-gray-700"
                        >
                             Sign up with Apple
                        </a>
                    </span>
                ...
                <div class="mt-4" id="google-signin">
                    <span class="block w-full rounded-md shadow-sm">
                        <a
                            :href="this.googleEndpoint"
                            class="flex items-center justify-center w-full px-4 py-2 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:ring-indigo active:bg-indigo-700"
                        >
                            <svg
