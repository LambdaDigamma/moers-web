            ...
            <div class="flex-1 w-0">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <h1 class="mt-0 text-base font-semibold leading-6 text-gray-900 lg:text-xl">{{ event.name }}</h1>
                        <div class="mt-0">
            ...
            <div class="flex-shrink-0 ml-8 w-80">
                <div class="flex flex-col justify-end" v-if="event.organisation">
                    <div class="bg-white rounded-lg shadow">
                        <div class="relative h-40" v-if="event.organisation && event.organisation.header_url">
                            <img class="absolute inset-0 object-cover w-full h-full rounded-t-lg"
                                 :src="event.organisation.header_url" alt="">
                        </div>

                        <div class="flex flex-col px-4 py-5 sm:p-6">
                            <div class="relative">
                                <span class="text-sm font-medium leading-5 text-gray-500 truncate">Veranstalter</span>
                                <h1 class="text-xl font-semibold">
                                    {{ event.organisation.name }}
                                </h1>
                                <p class="text-sm text-gray-700 truncate-2-lines">
                                ...
                                <div class="absolute top-0 right-0 z-40 -mt-10">
                                    <div class="p-3 bg-gray-700 rounded-md shadow-lg">
                ...
                <div class="flex flex-col justify-end mt-12" v-if="event.entry">
                    <div class="bg-white rounded-lg shadow">
                        ...
                        <div class="flex flex-col px-4 py-5 sm:p-6">
                            <div class="relative">
                                <span class="text-sm font-medium leading-5 text-gray-500 truncate">Veranstaltungsort</span>
