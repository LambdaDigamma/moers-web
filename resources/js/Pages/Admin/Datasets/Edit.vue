            ...
            <div class="px-4 py-5 sm:p-0">
                <dl>
                    ...
                    <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                        ...
                        <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ dataset.updated_at | moment('dddd, Do MMMM, H:mm') }}
                        </dd>
                    </div>
                    <div class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                        <dt class="text-sm font-medium leading-5 text-gray-500">
                        ...
                        <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                            {{ dataset.created_at | moment('dddd, Do MMMM, H:mm') }}
                        </dd>
                    </div>
                </dl>
            </div>
                ...
                <div class="flex flex-wrap items-center justify-between -mt-4 -ml-4 sm:flex-no-wrap">
                    <div class="mt-4 ml-4">
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-500">
                            Füge Datenquellen in verschiedenen Formaten zur weiteren Verwendung hinzu.
                        </p>
                    </div>
                                ...
                                <tr v-for="resource in dataset.resources" class="border-b border-gray-200 last:border-0">
                                    ...
                                    <td class="px-2 py-4 whitespace-no-wrap">
                                        <div class="flex items-center text-sm font-medium leading-5 text-gray-900">
                                            ...
                                            <svg v-else class="w-6 h-6 mt-1 text-red-400" fill="currentColor" viewBox="0 0 20 20">
