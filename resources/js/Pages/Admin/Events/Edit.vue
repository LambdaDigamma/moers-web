    ...
    export default {
        ...
        methods: {
            ...
            languageChanged(languageCode) {
                ...
                this.$inertia.visit(this.route('admin.events.edit', [this.event.id, languageCode]), {
                    method: 'get',
                    data: {},
                    preserveState: false,
                    preserveScroll: true,
            ...
            submitPage(blocks) {
                ...
                this.$inertia.put(this.route('admin.events.update', [this.event.id, this.lang]), data, {
                    replace: false,
                    preserveState: false,
                    preserveScroll: true,
                    only: [],
