                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-500">
                            Gib hier ein, wann der Livestream starten soll und
                            hinterlege den Link.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="bg-white rounded-md shadow">
                            ...
                            >
                                <span class="inline-flex rounded-md shadow-sm">
                                    <button
                                        type="submit"
                                        class="inline-flex justify-center px-4 py-2 text-sm font-medium leading-5 text-white transition duration-150 ease-in-out bg-blue-600 border border-transparent rounded-md hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:ring-blue active:bg-blue-700"
                                    >
                                        Speichern
                                    </button>
                                </span>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-500">
                            Wenn gerade keine Veranstaltung gespielt wird,
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="col-span-3 sm:col-span-3">
                                        <TextInput
                                            label="Titel"
                                            placeholder="Titel"
                                            v-model="form.failure_title"
                                            :errors="$page.errors.failure_title"
                                        />
                                    </div>
                                </div>
                                <div class="grid grid-cols-3 gap-6 mt-6">
                                    <div class="col-span-3 sm:col-span-3">
                                        <TextInput
                                            ...
                                            :errors="
                                                $page.errors.failure_description
                                            "
                                        />
                                    </div>
                                </div>
...
import TimePicker from "@/Shared/UI/TimePicker.vue";
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                url: this.stream.url,
                startDate:
                    this.stream.start_date !== null
                        ? moment(this.stream.start_date).toDate()
                        : null,
                startTime:
                    this.stream.start_date !== null
                        ? moment(this.stream.start_date).format("HH:mm")
                        : null,
    ...
    methods: {
        submit() {
            ...
            this.$inertia.post(
                this.route("admin.moers-festival.stream.update"),
                formData
            );
        },
    },
