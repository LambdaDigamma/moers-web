<template>
    <div>
        <header class="py-10">
            <h1 class="text-3xl font-bold leading-9">Dashboard</h1>
        </header>
        <main>
            ...
            >
                ...
                <!--                            <div class="flex-shrink-0 p-3 bg-gray-800 rounded-md">-->
                ...
                <!--                            <inertia-link href="#" class="font-medium text-gray-800 transition duration-150 ease-in-out hover:text-gray-900">-->
                <!--                                Alle ansehen-->
                <!--                            </inertia-link>-->
                <!--                        </div>-->
                <!--                    </div>-->
                ...
                <div class="overflow-hidden bg-white rounded-lg shadow">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="flex items-center">
                            <div
                                class="flex-shrink-0 p-3 bg-gray-800 rounded-md"
                            >
                                <svg
                            ...
                            <div class="flex-1 w-0 ml-5">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <div
                                            class="text-2xl font-semibold leading-8 text-gray-900"
                                        >
                    ...
                    <div class="px-4 py-4 bg-gray-100 sm:px-6">
                        <div class="text-sm leading-5">
                            <inertia-link
                                ...
                                class="font-medium text-gray-800 transition duration-150 ease-in-out hover:text-gray-900"
                            >
                                Alle ansehen
                            </inertia-link>
                        </div>
