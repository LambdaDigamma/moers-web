<template>
    ...
    <div>
        ...
        <h1 class="font-bold text-4xl dark:text-white">Seiten</h1>
        ...
        <div class="mt-3 mb-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <!--        <inertia-link :href="route('admin.pages.create')" class="px-3 py-2 bg-green-700 rounded-lg text-white font-semibold text-lg hover:no-underline">-->
            <!--            <span>Erstellen</span>-->
            <!--        </inertia-link>-->
        </div>
