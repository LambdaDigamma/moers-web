<template>
    ...
    <div class="pb-48">
        ...
        <div class="flex flex-row items-center mt-2 ml-2 text-sm text-gray-400" v-if="request.served_on !== null">
        ...
        <div class="mt-6 overflow-hidden bg-white shadow sm:rounded-lg" v-if="isCreator">
            <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                <h3 class="text-lg font-medium leading-6 text-gray-900">
                    Aktionen
                </h3>
        ...
        <div class="mt-6 overflow-hidden bg-white shadow sm:rounded-lg" v-if="isHelper">
            <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                <h3 class="text-lg font-medium leading-6 text-gray-900">
                    Aktionen
                </h3>
            ...
            <div class="px-4 py-5 sm:p-6">
                <div v-if="request.served_on !== null">
                    ...
                    <p class="max-w-xl mt-2 text-sm leading-5 text-gray-500">
                        Wenn du austrittst, wird die Hilfesuche wieder jedem angezeigt und kann von jemand anderem ausgeführt werden.
                        Die Konversation und alle verbundenen Nachrichten werden vollständig gelöscht.
                    </p>
                </div>
            </div>
        </div>
