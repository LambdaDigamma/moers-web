    ...
    <div class="mt-6">
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        placeholder="Suche nach Stadtteil oder Schlagwort"
                        v-model="form.search"
                    />
                </div>
            </div>
        ...
        <div class="mt-6 overflow-hidden bg-white rounded-lg shadow">
            <div class="px-4 py-5 sm:p-6">
                <p class="max-w-4xl">
                    Momentan benötigt hier niemand deine Hilfe. Aber schaue in
                    der nächsten Zeit noch mal nach!
                </p>
            </div>
        </div>

        <HelpItem
            v-for="(request, index) in helpRequests.data"
            :key="index"
            :request="request"
            class="mt-6"
        />
