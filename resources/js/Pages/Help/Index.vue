<template>
    ...
    <div>
        <div class="pb-48 mt-4 md:mt-8">
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="flex flex-col mt-8 md:flex-row">
                        <div class="flex flex-col items-center w-full text-center md:w-1/3">
                            ...
                            <h1 class="text-xl font-bold leading-9 text-center text-gray-900 sm:leading-10">
                                Hilf lokal!
                            </h1>
                        ...
                        <div class="flex flex-col items-center w-full mt-3 text-center md:mt-0 md:w-1/3">
                            <svg viewBox="0 0 20 20" fill="currentColor" class="w-12 h-12 text-gray-900">
            ...
            <div class="mt-4 overflow-hidden bg-gray-200 rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h2 class="text-2xl font-bold leading-9 text-gray-900 sm:text-2xl sm:leading-10">
                            ...
                            <div class="md:grid md:grid-cols-12 md:gap-8">
                                ...
                                <dd class="mt-2 md:mt-0 md:col-span-7">
                                    <p class="text-base leading-6 text-gray-500">
                                        <inertia-link :href="route('help.serve')" class="font-medium text-gray-600 hover:underline">Hier</inertia-link> kannst du sehen, welche Hilfe gebraucht wird und Kontakt mit den Hilfesuchenden aufnehmen.
                                        Zusätzlich kannst du auch informiert werden, wenn Menschen in deinem Stadtteil in Zukunft Hilfe suchen.
                                    </p>
                                </dd>
                            </div>
                            <div class="pt-6 mt-8 border-t border-gray-300 md:grid md:grid-cols-12 md:gap-8">
                                <dt class="text-base font-medium leading-6 text-gray-900 md:col-span-5">
                                    Ich benötige Hilfe! Aber wie?
                                </dt>
                                <dd class="mt-2 md:mt-0 md:col-span-7">
                                    <p class="text-base leading-6 text-gray-500">
                                        <inertia-link :href="route('help.need')" class="font-medium text-gray-600 hover:underline">Hier</inertia-link> kannst du eintragen, dass du Hilfe benötigst.
