                                ...
                                <div class="grid grid-cols-3 gap-6 mt-6">
                                    <div class="col-span-3 sm:col-span-2">
                                        <TextInput
                                            ...
                                            :disabled="
                                                personalInformation.canChangeEmail
                                            "
                                        />
                                    </div>
                                </div>
            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm leading-5 text-gray-500">
                            Exportiere alle Daten, die wir über dich haben oder
                    ...
                    <form action="#" method="POST">
                        <div class="overflow-hidden rounded-md shadow">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                >
                                    <p>
                                        Du kannst alle personenbezogenen Daten
                                        anfordern und erhälst diese dann per
                                        E-Mail.
                                    </p>
                                </div>
                                <div class="mt-5">
                    ...
                    <form action="#" method="POST" class="mt-6">
                        <div class="overflow-hidden rounded-md shadow">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                >
                                    <p>
                                        Sobald du dein Konto löschst, verlierst
                                        du alle damit verbundenen Daten.
                                    </p>
                                </div>
                                <div class="mt-5">
                                    <button
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.put(this.route("profile.update"), this.form);
        },
        showDeletionModal() {
            let r = confirm(
                "Möchtest du dein Benutzerkonto wirklich löschen? Dies kann nicht rückgängig gemacht werden."
            );
            if (r === true) {
