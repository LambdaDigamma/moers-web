                                    ...
                                    <ul class="space-y-8">
                                            ...
                                            <div class="flex space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1 text-sm text-gray-700">
                                                        <p>Ducimus quas delectus ad maxime totam doloribus reiciendis
                                                            ex.
                                        ...
                                        <li>
                                            <div class="flex space-x-3">
                                                <div class="flex-shrink-0">
                                                    <img class="w-10 h-10 rounded-full"
                                                        src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixqx=ThAiHdGqH9&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                                                        alt="">
                                                </div>
                                                <div>
                                                    <div class="text-sm">
                                                    ...
                                                    <div class="mt-1 text-sm text-gray-700">
                                                        <p>Et ut autem. Voluptatem eum dolores sint necessitatibus quos.
                                                            Quis eum qui dolorem accusantium voluptas voluptatem ipsum.
                                                            Quo
                                        ...
                                        <li>
                                            <div class="flex space-x-3">
                                                <div class="flex-shrink-0">
                                                    <img class="w-10 h-10 rounded-full"
                                                        src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixqx=ThAiHdGqH9&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                                                        alt="">
                                                </div>
                                                <div>
                                                    <div class="text-sm">
                                                    ...
                                                    <div class="mt-1 text-sm text-gray-700">
                                                        <p>Expedita consequatur sit ea voluptas quo ipsam recusandae. Ab
                                                            sint et voluptatem repudiandae voluptatem et eveniet. Nihil
                                                            quas
                ...
                <div class="lg:col-start-3 lg:col-span-1">
                    ...
                    <section aria-labelledby="organizer-title">
                        <div class="px-4 py-5 bg-white shadow sm:rounded-lg sm:px-6">
                            ...
                            <h3 id="organizer-title" class="text-lg font-medium text-gray-900">Stadt Moers</h3>
