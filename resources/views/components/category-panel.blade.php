<div {{ $attributes->merge(['class' => '']) }}>
    <div
        class="overflow-hidden bg-gray-200 divide-y divide-gray-200 rounded-lg shadow-lg sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
        <x-category-panel-item></x-category-panel-item>
        ...
        <div
            ...
            <div>
                <span class="inline-flex p-3 rounded-lg bg-light-blue-50 text-light-blue-700 ring-4 ring-white">
