    ...
    <div class="max-w-6xl px-4 py-12 mx-auto sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="pt-8 mt-8 border-t border-gray-700 md:flex md:items-center md:justify-between">
            <div class="flex space-x-6 md:order-2">
                ...
                <a class="text-gray-400 hover:text-gray-300" href="https://instagram.com/lennartfischer" rel="noopener"
                    target="_blank">
                ...
                <a class="text-gray-400 hover:text-gray-300" href="https://twitter.com/lambdadigamma" rel="noopener"
                    target="_blank">
                ...
                <a class="text-gray-400 hover:text-gray-300" href="https://github.com/lambdadigamma" rel="noopener"
                    target="_blank">
            ...
            <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
                &copy; {{ now()->year }} Lennart Fischer. All rights reserved.
            </p>
        </div>
    </div>
</footer>