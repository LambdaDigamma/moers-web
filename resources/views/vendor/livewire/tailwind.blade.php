                ...
                <span class="relative z-0 inline-flex rounded-md shadow-sm">
                    ...
                    <span
                        ...
                        <span aria-current="page">
                            <span
                                class="relative z-10 inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-blue-600 border border-blue-500 cursor-default select-none bg-blue-50">{{
                                $page }}</span>
                        </span>
                        @else
