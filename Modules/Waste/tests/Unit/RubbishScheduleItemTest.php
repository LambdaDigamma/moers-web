...
test('rubbish schedule item factory', function () {
...
test('rubbish schedule item route accessors and mutators', function () {
...
test('rubbish schedule item upcoming scope', function () {
