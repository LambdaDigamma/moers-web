        ...
        <div>
            <span class="relative z-0 inline-flex rounded-md shadow-sm">
                ...
                <span aria-current="page">
                    <span
                        class="relative z-10 inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-indigo-600 border border-indigo-500 cursor-default bg-indigo-50">{{
                        $page }}</span>
                </span>
                @else
                <a href="{{ $url }}"
