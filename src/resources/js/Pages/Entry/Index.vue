<template>
    <div class="h-full">
        ...
        <div
            class="absolute inset-y-0 right-0 w-1/4 h-full p-8 w-80"
            style="z-index: 500"
        >
            <div
                class="flex flex-col h-full overflow-hidden bg-white rounded-lg shadow-md"
            >
                ...
                <div class="flex flex-col h-full" v-else>
                    <div
                        class="flex-shrink-0 px-4 py-5 bg-white border-b border-gray-200 sm:px-6"
                    >
                        <div class="w-full">
                            <label for="search" class="sr-only"
                                >Eintrag suchen…</label
                            >
                            <div class="relative">
                                <div
                    ...
                    <div
                        v-if="true"
                        class="flex flex-wrap px-4 py-3 border-b border-gray-200 sm:px-6"
                    >
                        <span
                    ...
                    <div class="overflow-y-scroll" scroll-region>
                        <ul>
                            ...
                            >
                                <inertia-link
                                    :href="route('entries.index', entry.id)"
...
<script>
import LayoutGeneralFluid from "@/Shared/Layouts/LayoutGeneralFluid.vue";
import PrimaryButton from "@/Shared/UI/PrimaryButton.vue";
import WhiteButton from "@/Shared/UI/WhiteButton.vue";
import EntryDetail from "@/Shared/Entry/EntryDetail.vue";
