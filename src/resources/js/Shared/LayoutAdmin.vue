    ...
    <div>
        ...
        >
            ...
            <div class="hidden m-4 mr-2 md:flex md:flex-shrink-0">
                <div
                    class="flex flex-col w-64 overflow-hidden rounded-lg shadow-xl"
                >
                    <div
                        class="flex items-center flex-shrink-0 h-16 px-4 bg-gray-900"
                    >
                    ...
                    <div class="flex flex-col flex-1 h-0 overflow-y-auto">
                        ...
                        <nav class="flex-1 px-2 py-4 space-y-1 bg-gray-800">
                            ...
                            <div class="mt-8">
                                <h3
                                    class="px-3 text-xs font-semibold leading-4 tracking-wider text-gray-400 uppercase"
                                >
                                    Sonstiges
                                </h3>
            ...
            <div class="flex flex-col flex-1 w-0 overflow-hidden">
                <div
                    class="relative z-10 flex flex-shrink-0 h-16 m-4 ml-2 bg-white rounded-lg shadow"
                >
                    <button
