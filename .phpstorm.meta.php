    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'db.connection' => \Limenet\LaravelMysqlSpatial\MysqlConnection::class,
            'db.factory' => \Limenet\LaravelMysqlSpatial\Connectors\ConnectionFactory::class,
            'db.schema' => \Limenet\LaravelMysqlSpatial\Schema\Builder::class,
    ...
    override(\config(), map([
            'api-language.supported_locales' => 'string',
            ...
            'charts.global_middlewares' => 'string',
            ...
            'filesystems.links./Users/lennart/Documents/Development/Laravel/mein-moers/public/storage' => 'string',
            ...
            'mm-pages.api_middleware' => 'string',
            'mm-pages.admin_prefix' => 'string',
            'mm-pages.admin_middleware' => 'string',
            'mm-pages.admin_middleware_stateless' => 'string',
            ...
            'services.sign_in_with_apple.login' => 'string',
            'services.sign_in_with_apple.redirect' => 'string',
            'services.sign_in_with_apple.client_id' => 'string',
            'services.sign_in_with_apple.client_secret' => 'string',
...
'api-language.supported_locales','api-language.use_autoscan_lang_folder','app.name','app.env','app.debug',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','audit.enabled','audit.implementation',
'audit.user.morph_prefix','audit.user.guards','audit.resolvers.ip_address','audit.resolvers.user_agent','audit.resolvers.url',
...
'audit.console','audit.resolver.user','audit.resolver.ip_address','audit.resolver.user_agent','audit.resolver.url',
...
'auth.password_timeout','blade-icons.sets.default.path','blade-icons.sets.default.prefix','blade-icons.sets.default.class','blade-icons.class',
'blade-icons.attributes','blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','broadcasting.default',
...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','charts.global_route_prefix','charts.global_middlewares',
'charts.global_route_name_prefix','cors.paths','cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns',
...
'debugbar.hide_empty_tabs','debugbar.except','debugbar.storage.enabled','debugbar.storage.driver','debugbar.storage.path',
'debugbar.storage.connection','debugbar.storage.provider','debugbar.editor','debugbar.remote_sites_path','debugbar.local_sites_path',
...
'filesystems.links./Users/lennart/Documents/Development/Laravel/mein-moers/public/storage','google-fonts.fonts.default','google-fonts.disk','google-fonts.path','google-fonts.inline',
'google-fonts.preload','google-fonts.fallback','google-fonts.user_agent','hashing.driver','hashing.bcrypt.rounds',
'hashing.argon.memory','hashing.argon.threads','hashing.argon.time','hashing.rehash_on_login','horizon.domain',
...
'ide-helper.format','ide-helper.custom_db_types','json-api-paginate.max_results','json-api-paginate.default_size','json-api-paginate.number_parameter',
...
'json-api-paginate.use_fast_pagination','json-api-paginate.base_url','json-api-paginate.pagination_parameter','jsonapi.namespace','jsonapi.servers',
...
'livewire.inject_morph_markers','livewire.pagination_theme','livewire.asset_url','livewire.middleware_group','livewire.manifest_path',
...
'media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','mm-events.event_default_duration','mm-events.event_active_duration',
'mm-events.places_table','mm-events.admin_prefix','mm-events.admin_middleware','mm-events.admin_as','mm-events.api_prefix',
'mm-events.api_middleware','mm-events.min_long_event_duration','mm-feeds.feed_model','mm-feeds.post_model','mm-feeds.api_prefix',
'mm-feeds.api_middleware','mm-feeds.admin_prefix','mm-feeds.admin_middleware','mm-pages.page_model','mm-pages.page_block_model',
'mm-pages.api_prefix','mm-pages.api_disable_page_endpoint','mm-pages.api_middleware','mm-pages.admin_prefix','mm-pages.admin_middleware',
'mm-pages.admin_middleware_stateless','newsletter.apiKey','newsletter.defaultListName','newsletter.lists.Mein Moers Android.id','newsletter.ssl',
...
'personal-data-export.job.queue','personal-data-export.job.connection','personal-data-export.mailable','pulse.domain','pulse.path',
...
'seotools.meta.defaults.title','seotools.meta.defaults.description','seotools.meta.defaults.titleBefore','seotools.meta.defaults.separator','seotools.meta.defaults.keywords',
...
'seotools.meta.webmaster_tags.pinterest','seotools.meta.webmaster_tags.yandex','seotools.meta.webmaster_tags.norton','seotools.meta.add_notranslate_class','seotools.opengraph.defaults.url',
'seotools.opengraph.defaults.title','seotools.opengraph.defaults.description','seotools.opengraph.defaults.type','seotools.opengraph.defaults.site_name','seotools.opengraph.defaults.images',
'seotools.twitter.defaults.card','seotools.twitter.defaults.site','seotools.json-ld.defaults.url','seotools.json-ld.defaults.title','seotools.json-ld.defaults.description',
'seotools.json-ld.defaults.type','seotools.json-ld.defaults.images','services.sign_in_with_apple.login','services.sign_in_with_apple.redirect','services.sign_in_with_apple.client_id',
'services.sign_in_with_apple.client_secret','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
...
'services.sparkpost.secret','services.stripe.model','services.stripe.key','services.stripe.secret','services.google.client_id',
'services.google.client_secret','services.google.redirect','services.apple.team','services.apple.maps_key_id','services.apple.maps_key',
...
'session.partitioned','settings.store','settings.path','settings.connection','settings.table',
'settings.keyColumn','settings.valueColumn','settings.enableCache','settings.forgetCacheByWrite','settings.cacheTtl',
'settings.defaults.foo','sitemap.guzzle_options.cookies','sitemap.guzzle_options.connect_timeout','sitemap.guzzle_options.timeout','sitemap.guzzle_options.allow_redirects',
'sitemap.execute_javascript','sitemap.chrome_binary_path','sitemap.crawl_profile','telescope.domain','telescope.path',
...
'telescope.ignore_paths','telescope.ignore_commands','telescope.watchers.Laravel\\Telescope\\Watchers\\CacheWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.ignore',
'telescope.watchers.Laravel\\Telescope\\Watchers\\DumpWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.ignore','telescope.watchers.Laravel\\Telescope\\Watchers\\ExceptionWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher',
'telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\MailWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ModelWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\ModelWatcher.events','telescope.watchers.Laravel\\Telescope\\Watchers\\NotificationWatcher',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_abilities','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher',
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','translatable.fallback_locale','view.paths','view.compiled','concurrency.default',
'blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class','blade-heroicons.attributes','inertia.ssr.enabled',
...
'passport.personal_access_client.id','passport.personal_access_client.secret','saloon.default_sender','saloon.integrations_path','flare.key',
...
'query-builder.convert_field_names_to_snake_case','json-api-client.base_uri','wire-elements-modal.include_css','wire-elements-modal.include_js','wire-elements-modal.component_defaults.modal_max_width',
'wire-elements-modal.component_defaults.close_modal_on_click_away','wire-elements-modal.component_defaults.close_modal_on_escape','wire-elements-modal.component_defaults.close_modal_on_escape_is_forceful','wire-elements-modal.component_defaults.dispatch_close_event','wire-elements-modal.component_defaults.destroy_on_close',
...
'livewire.rubbish.search','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
'marketing','news.index','notifications::email','pages.app','pages.events.index',
'pages.events.show','pages.index','pagination::simple-tailwind','pagination::tailwind','parking-area.index',
'parking-area.show','passport::authorize','petrol.index','pulse::dashboard','rubbish.index',
'rubbish.show','vendor.livewire-ui-modal.modal','vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind',
'vendor.livewire.tailwind','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.mail.text.subcopy','vendor.mail.text.table','vendor.notifications.email','vendor.pagination.simple-tailwind','vendor.pagination.tailwind',
'vendor.passport.authorize','vendor.personal-data-export.mail','vendor.pulse.dashboard','02a8dc4cf01fed584c6423f577c0b0d7::card','02a8dc4cf01fed584c6423f577c0b0d7::card-header',
...
'02a8dc4cf01fed584c6423f577c0b0d7::th','02a8dc4cf01fed584c6423f577c0b0d7::thead','02a8dc4cf01fed584c6423f577c0b0d7::theme-switcher','02a8dc4cf01fed584c6423f577c0b0d7::user-card','horizon::layout',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','passport::authorize','pulse::components.card',
...
'pulse::livewire.usage','reverb::components.icons.reverb','reverb::livewire.connections','reverb::livewire.messages','sitemap::image',
'sitemap::news','sitemap::sitemap','sitemap::sitemapIndex.index','sitemap::sitemapIndex.sitemap','sitemap::url',
'sitemap::video','wire-elements-modal::modal',);
        registerArgumentsSet('translations', 
'auth.failed','auth.password','auth.throttle','auth.reset-password','auth.email',
'auth.password-confirm','auth.send-link','pagination.previous','pagination.next','passwords.reset',
...
'validation.custom.attribute-name.rule-name','de.0','events.attendance_online','events.attendance_offline','events.attendance_mixed',
...
'validation.attributes.date','validation.attributes.time','validation.attributes.available','validation.attributes.size','validation.attributes.url',
'validation.attributes.nickname','validation.attributes.birthday','validation.attributes.slogan','validation.attributes.motto','validation.attributes.strengths',
'validation.attributes.weaknesses','validation.attributes.lkA','validation.attributes.lkB','validation.attributes.highlight','validation.attributes.soundtrack',
'validation.attributes.miss_least','validation.attributes.miss_most','validation.attributes.photo_old','validation.attributes.photo_new','validation.attributes.place',
'validation.attributes.postcode','validation.attributes.house_number','validation.attributes.street','validation.attributes.monday','validation.attributes.tuesday',
'validation.attributes.wednesday','validation.attributes.thursday','validation.attributes.friday','validation.attributes.saturday','validation.attributes.sunday',
'validation.attributes.other','validation.attributes.tags','jsonapi-spec::spec.json_empty.title','jsonapi-spec::spec.json_empty.detail','jsonapi-spec::spec.json_empty.code',
'jsonapi-spec::spec.json_error.title','jsonapi-spec::spec.json_not_object.title','jsonapi-spec::spec.json_not_object.detail','jsonapi-spec::spec.json_not_object.code','jsonapi-spec::spec.member_required.title',
'jsonapi-spec::spec.member_required.detail','jsonapi-spec::spec.member_required.code','jsonapi-spec::spec.member_object_expected.title','jsonapi-spec::spec.member_object_expected.detail','jsonapi-spec::spec.member_object_expected.code',
'jsonapi-spec::spec.member_array_expected.title','jsonapi-spec::spec.member_array_expected.detail','jsonapi-spec::spec.member_array_expected.code','jsonapi-spec::spec.member_identifier_expected.title','jsonapi-spec::spec.member_identifier_expected.detail',
'jsonapi-spec::spec.member_identifier_expected.code','jsonapi-spec::spec.member_string_expected.title','jsonapi-spec::spec.member_string_expected.detail','jsonapi-spec::spec.member_string_expected.code','jsonapi-spec::spec.member_empty.title',
'jsonapi-spec::spec.member_empty.detail','jsonapi-spec::spec.member_empty.code','jsonapi-spec::spec.member_field_not_allowed.title','jsonapi-spec::spec.member_field_not_allowed.detail','jsonapi-spec::spec.member_field_not_allowed.code',
'jsonapi-spec::spec.member_field_not_supported.title','jsonapi-spec::spec.member_field_not_supported.detail','jsonapi-spec::spec.member_field_not_supported.code','jsonapi-spec::spec.field_expects_to_one.title','jsonapi-spec::spec.field_expects_to_one.detail',
'jsonapi-spec::spec.field_expects_to_one.code','jsonapi-spec::spec.field_expects_to_many.title','jsonapi-spec::spec.field_expects_to_many.detail','jsonapi-spec::spec.field_expects_to_many.code','jsonapi-spec::spec.resource_type_not_supported.title',
'jsonapi-spec::spec.resource_type_not_supported.detail','jsonapi-spec::spec.resource_type_not_supported.code','jsonapi-spec::spec.resource_type_not_supported_by_to_one_relationship.title','jsonapi-spec::spec.resource_type_not_supported_by_to_one_relationship.detail','jsonapi-spec::spec.resource_type_not_supported_by_to_one_relationship.code',
'jsonapi-spec::spec.resource_type_not_supported_by_to_many_relationship.title','jsonapi-spec::spec.resource_type_not_supported_by_to_many_relationship.detail','jsonapi-spec::spec.resource_type_not_supported_by_to_many_relationship.code','jsonapi-spec::spec.resource_type_not_recognised.title','jsonapi-spec::spec.resource_type_not_recognised.detail',
'jsonapi-spec::spec.resource_type_not_recognised.code','jsonapi-spec::spec.resource_id_not_supported.title','jsonapi-spec::spec.resource_id_not_supported.detail','jsonapi-spec::spec.resource_id_not_supported.code','jsonapi-spec::spec.resource_client_ids_not_supported.title',
'jsonapi-spec::spec.resource_client_ids_not_supported.detail','jsonapi-spec::spec.resource_client_ids_not_supported.code','jsonapi-spec::spec.resource_exists.title','jsonapi-spec::spec.resource_exists.detail','jsonapi-spec::spec.resource_exists.code',
'jsonapi-spec::spec.resource_not_found.title','jsonapi-spec::spec.resource_not_found.detail','jsonapi-spec::spec.resource_not_found.code','jsonapi-spec::spec.resource_field_exists_in_attributes_and_relationships.title','jsonapi-spec::spec.resource_field_exists_in_attributes_and_relationships.detail',
'jsonapi-spec::spec.resource_field_exists_in_attributes_and_relationships.code','jsonapi-validation::validation.invalid.title','jsonapi-validation::validation.invalid.detail','jsonapi-validation::validation.invalid.code','jsonapi-validation::validation.resource_invalid.title',
'jsonapi-validation::validation.resource_invalid.detail','jsonapi-validation::validation.resource_invalid.code','jsonapi-validation::validation.query_invalid.title','jsonapi-validation::validation.query_invalid.detail','jsonapi-validation::validation.query_invalid.code',
'jsonapi-validation::validation.delete_invalid.title','jsonapi-validation::validation.delete_invalid.detail','jsonapi-validation::validation.delete_invalid.code','jsonapi-validation::validation.allowed_field_sets.default','jsonapi-validation::validation.allowed_field_sets.singular',
'jsonapi-validation::validation.allowed_field_sets.plural','jsonapi-validation::validation.allowed_field_sets.unrecognised.singular','jsonapi-validation::validation.allowed_field_sets.unrecognised.plural','jsonapi-validation::validation.allowed_filter_parameters.default','jsonapi-validation::validation.allowed_filter_parameters.singular',
'jsonapi-validation::validation.allowed_filter_parameters.plural','jsonapi-validation::validation.allowed_include_paths.default','jsonapi-validation::validation.allowed_include_paths.singular','jsonapi-validation::validation.allowed_include_paths.plural','jsonapi-validation::validation.allowed_sort_parameters.default',
'jsonapi-validation::validation.allowed_sort_parameters.singular','jsonapi-validation::validation.allowed_sort_parameters.plural','jsonapi-validation::validation.allowed_page_parameters.default','jsonapi-validation::validation.allowed_page_parameters.singular','jsonapi-validation::validation.allowed_page_parameters.plural',
'jsonapi-validation::validation.allowed_countable_fields.default','jsonapi-validation::validation.allowed_countable_fields.singular','jsonapi-validation::validation.allowed_countable_fields.plural','jsonapi-validation::validation.boolean_string','jsonapi-validation::validation.client_id',
'jsonapi-validation::validation.date_time_iso_8601','jsonapi-validation::validation.json_boolean','jsonapi-validation::validation.json_integer','jsonapi-validation::validation.json_number','jsonapi-validation::validation.json_array',
'jsonapi-validation::validation.json_object','jsonapi-validation::validation.parameter_not_supported','jsonapi-validation::validation.has_one','jsonapi-validation::validation.has_many','personal-data-export::notifications.subject',
'personal-data-export::notifications.instructions','personal-data-export::notifications.action','personal-data-export::notifications.deletion_message',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'TELESCOPE_ENABLED','DEBUGBAR_ENABLED','LOG_CHANNEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','SANCTUM_STATEFUL_DOMAINS',
'SESSION_DOMAIN','SESSION_COOKIE','ASSET_URL','SSL_MODE','BROADCAST_DRIVER',
'CACHE_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','QUEUE_DRIVER','REDIS_CLIENT',
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','MAIL_DRIVER','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER',
'VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER','SIGN_IN_WITH_APPLE_LOGIN','SIGN_IN_WITH_APPLE_REDIRECT','SIGN_IN_WITH_APPLE_CLIENT_ID',
'SIGN_IN_WITH_APPLE_CLIENT_SECRET','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT','APPLE_DEVELOPER_TEAM',
'APPLE_MAPS_KEY_ID','APPLE_MAPS_KEY','MIX_MAP_BOX_KEY','GITHUB_ACCESS_TOKEN','LF_GITHUB_ACCESS_TOKEN',
'SPATIE_USERNAME','SPATIE_PASSWORD','VITE_APP_NAME','REVERB_APP_ID','REVERB_APP_KEY',
