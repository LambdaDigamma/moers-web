...
namespace Illuminate\Support\Facades {
    ...
    class Route {
        ...
        {
                        return Router::personalDataExports($url);
        }
...
namespace Silber\Bouncer
{
    ...
    class BouncerFacade {
         ...
         * @return GivesAbilities
         * @static 
         */ 
        public static function allow($authority)
        {
                        /** @var Bouncer $instance */
         ...
         *
         * @param Role|Collection|string $roles
         * @return AssignsRoles
         * @static 
         */ 
         ...
         *
         * @param Collection|Role|string $roles
         * @return RemovesRoles
         * @static 
         */ 
...
namespace
{
    ...
    class Eloquent extends Model {
            ...
            {
                                return Builder::addSubSelect($column, $query);
            }
            ...
            {
                                return Builder::orderBySub($query, $direction, $nullPosition);
            }
            ...
            {
                                return Builder::orderBySubAsc($query, $nullPosition);
            }
            ...
            {
                                return Builder::orderBySubDesc($query, $nullPosition);
            }
        }
...
namespace App
{
    ...
    /**
    * @method Collection|AdvEvent[]|AdvEvent create($attributes = [])
    * @method Collection|AdvEvent[]|AdvEvent make($attributes = [])
    */
    class AdvEventFactoryBuilder extends FactoryBuilder {}
}
