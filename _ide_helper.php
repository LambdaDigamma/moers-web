 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \Limenet\LaravelMysqlSpatial\MysqlConnection $instance */
        ...
        {            //Method inherited from \Illuminate\Database\Connection         
                        \Limenet\LaravelMysqlSpatial\MysqlConnection::resolverFor($driver, $callback);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Connection         
                        return \Limenet\LaravelMysqlSpatial\MysqlConnection::getResolver($driver);
        }
                    /**
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Database\Schema\MySqlBuilder         
                        /** @var \Limenet\LaravelMysqlSpatial\Schema\Builder $instance */
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Limenet\LaravelMysqlSpatial\Schema\Builder::defaultStringLength($length);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Limenet\LaravelMysqlSpatial\Schema\Builder::defaultMorphKeyType($type);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Limenet\LaravelMysqlSpatial\Schema\Builder::morphUsingUuids();
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Limenet\LaravelMysqlSpatial\Schema\Builder::morphUsingUlids();
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Limenet\LaravelMysqlSpatial\Schema\Builder::useNativeSchemaOperationsIfPossible($value);
        }
                    /**
         ...
         * @return \Limenet\LaravelMysqlSpatial\Schema\Builder 
         * @static 
         */ 
...
')
     ...
     */ 
        ...
        public static function make($data)
        {
                        /** @var \Swis\JsonApi\Client\DocumentFactory $instance */
                        return $instance->make($data);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function create($typeMapper = null)
        {
                        return \Swis\JsonApi\Client\Parsers\DocumentParser::create($typeMapper);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Swis\JsonApi\Client\Parsers\DocumentParser $instance */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function hydrate($item, $attributes, $id = null)
        {
                        /** @var \Swis\JsonApi\Client\ItemHydrator $instance */
                        return $instance->hydrate($item, $attributes, $id);
        }
     ...
     */ 
        ...
        public static function create($typeMapper = null)
        {
                        return \Swis\JsonApi\Client\Parsers\ResponseParser::create($typeMapper);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Swis\JsonApi\Client\Parsers\ResponseParser $instance */
                        return $instance->parse($response);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setMapping($type, $class)
        {
                        /** @var \Swis\JsonApi\Client\TypeMapper $instance */
                        return $instance->setMapping($type, $class);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function hasMapping($type)
        {
                        /** @var \Swis\JsonApi\Client\TypeMapper $instance */
                        return $instance->hasMapping($type);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function removeMapping($type)
        {
                        /** @var \Swis\JsonApi\Client\TypeMapper $instance */
                        return $instance->removeMapping($type);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Swis\JsonApi\Client\TypeMapper $instance */
                        return $instance->getMapping($type);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \Swis\JsonApi\Client\Providers\ServiceProvider::registerLaravelHttpClientMacros()
         * @return \Illuminate\Http\Client\PendingRequest 
         * @static 
         */ 
        public static function asJsonApi()
        {
                        return \Illuminate\Http\Client\PendingRequest::asJsonApi();
        }
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Client\Response::jsonApi();
        }
     ...
     */ 
         ...
         * 
         *
         * @see \LaravelArchivable\LaravelArchivableServiceProvider::configureMacros()
         * @param mixed $column
         * @param mixed $precision
         * @static 
         */ 
        public static function archivedAt($column = 'archived_at', $precision = 0)
        {
                        return \Illuminate\Database\Schema\Blueprint::archivedAt($column, $precision);
        }
                    /**
         * 
         *
         * @see \LaravelPublishable\LaravelPublishableServiceProvider::configureMacros()
         * @param mixed $column
         * @param mixed $precision
         * @static 
         */ 
        public static function publishedAt($column = 'published_at', $precision = 0)
        {
                        return \Illuminate\Database\Schema\Blueprint::publishedAt($column, $precision);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function expiredAt($column = 'expired_at', $precision = 0)
        {
                        return \Illuminate\Database\Schema\Blueprint::expiredAt($column, $precision);
        }
                    /**
         * 
         *
         * @see \LambdaDigamma\MMPages\MMPagesServiceProvider::configureMacros()
         * @param mixed $column
         * @param mixed $precision
         * @static 
         */ 
        public static function hiddenAt($column = 'hidden_at', $precision = 0)
        {
                        return \Illuminate\Database\Schema\Blueprint::hiddenAt($column, $precision);
        }
...
namespace  { 
            ...
            class ItemHydrator extends \Swis\JsonApi\Client\Facades\ItemHydratorFacade {}
            class ResponseParser extends \Swis\JsonApi\Client\Facades\ResponseParserFacade {}
            class TypeMapper extends \Swis\JsonApi\Client\Facades\TypeMapperFacade {}
